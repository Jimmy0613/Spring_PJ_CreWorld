...
<body>
<textarea style="width:600px; height:300px; resize:none;">제1조(목적)

본 회원약관은 CREWORLDRESORT(이하 '갑'라 한다)가 운영하는 인터넷관련 서비스(이하 '서비스'라 한다)를 이용함에 있어 관리자와 이용자(이하 '회원'라 한다)의 권리, 의무 및 책임사항을 규정함을 목적으로 한다.
...
제 1 조 (시행일) 이 약관은 2023년 3월 1일부터 시행한다.  </textarea>
</body>
</html>